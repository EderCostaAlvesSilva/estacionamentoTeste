...
$veiculos = $veiculo->deletarVeiculo();
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <div class=" mb-3 text-muted">Voce deseja excluir o veículo da <strong>placa</strong> 
                                        <?= $buscaVeiculo['placa'] ?> e <strong>modelo</strong> <?= $buscaVeiculo['modelo'] ?>, da  <strong>marca</strong>
                                        <?= $buscaVeiculo['marca'] ?>  ?
                                    </div>
                                ...
                                <div class="card-footer  py-3">
                                    <form action="" method="post">
                                        <div>
                                            ...
                                            <input type="hidden" name="id_veiculo" value="<?= $buscaVeiculo['id_veiculo'] ?>">
